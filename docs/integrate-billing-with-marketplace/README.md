    ...
    FROM customer_usage.json_raw_data
     ...
     parsed_data AS (
         SELECT
             ...
             json_extract_scalar(json_record, '$.hostClusterId') AS hostClusterId,
             json_extract_scalar(json_record, '$.cloudProvider') AS cloudProvider,
             json_extract_scalar(json_record, '$.region') AS region,
             json_extract_scalar(json_record, '$.customNetworkId') AS customNetworkId,
